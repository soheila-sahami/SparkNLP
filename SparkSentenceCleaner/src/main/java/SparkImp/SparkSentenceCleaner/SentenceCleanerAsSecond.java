...
public class SentenceCleanerAsSecond {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			printHelp();
			inputFile = "/home/sahami/Documents/workspace/Data/output/Segmentizer1stBig10G/Segmentized/part*";
			// "hdfs:///user/sahami/SentenceCleaner/input-raw-small/";
			outputDir = "/home/sahami/Documents/workspace/Data/output/SentenceCleaner2ndBig10G/";
		...
		// load input file
		JavaRDD<String> SegmentizedTextWithMetadata = sparkContext.textFile(inputFile);
		// <line,metaDataIdx>
		JavaRDD<Tuple2<String, Long>> sentences = SegmentizedTextWithMetadata.map(new SplitMetaData());
		...
		System.out.println("Runtime for Sentence Cleaner  " + (end - start) / 1000);
